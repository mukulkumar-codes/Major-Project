class SliderData {
  static List<dynamic> content = [
    {
      "title": "Welcome To SACI Chats",
      "subtitle":
      "A Private, Secure, End-to-End Encrypted Messaging app that helps you to connect with your connections without any Ads, promotion. No other third party person, organization can't read your messages.",
    },
    {
      "title": "Communicate With Security",
      "subtitle":
      "Chat Messages are End-to-End-Encrypted. No-other third party app can't read your messages.",
    },
    {
